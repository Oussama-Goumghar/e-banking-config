...
class NotificationResourceIT {
    ...
    private static final Long DEFAULT_ID_TRANSACTION = 1L;
    private static final Long UPDATED_ID_TRANSACTION = 2L;
    ...
    void createNotification() throws Exception {
        ...
        assertThat(testNotification.getIdTransaction()).isEqualTo(DEFAULT_ID_TRANSACTION);
        assertThat(testNotification.getPin()).isEqualTo(DEFAULT_PIN);
        assertThat(testNotification.getReference()).isEqualTo(DEFAULT_REFERENCE);
    ...
    void getAllNotifications() throws Exception {
        ...
        restNotificationMockMvc
            ...
            .andExpect(jsonPath("$.[*].idTransaction").value(hasItem(DEFAULT_ID_TRANSACTION.intValue())))
    ...
    void getNotification() throws Exception {
        ...
        restNotificationMockMvc
            ...
            .andExpect(jsonPath("$.idTransaction").value(DEFAULT_ID_TRANSACTION.intValue()))
    ...
    void putNewNotification() throws Exception {
        ...
        updatedNotification.idTransaction(UPDATED_ID_TRANSACTION).pin(UPDATED_PIN).reference(UPDATED_REFERENCE).status(UPDATED_STATUS);
        ...
        Notification testNotification = notificationList.get(notificationList.size() - 1);
        assertThat(testNotification.getIdTransaction()).isEqualTo(UPDATED_ID_TRANSACTION);
        assertThat(testNotification.getPin()).isEqualTo(UPDATED_PIN);
        assertThat(testNotification.getReference()).isEqualTo(UPDATED_REFERENCE);
    ...
    void partialUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.reference(UPDATED_REFERENCE).status(UPDATED_STATUS);
